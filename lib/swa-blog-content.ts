...
export const SWA_BLOG_ARTICLES: BlogArticleData[] = [
  {
    ...
    sezioni: [
      ...
      },
      {
        ...
        paragrafi: [
          'Social Automation propone due livelli mensili trasparenti. Il piano Presenza costa 390 euro al mese, IVA esclusa, e comprende 16 contenuti per due social. È pensato per imprese che devono comunicare con continuità e desiderano un flusso gestito di produzione, approvazione e pubblicazione.',

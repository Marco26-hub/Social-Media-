    ...
    sezioni: [
      {
        ...
        paragrafi: [
          ...
          'Le pratiche vietate — quelle a rischio inaccettabile — si applicano dal 2 febbraio 2025, insieme all’obbligo di garantire una alfabetizzazione adeguata sull’AI a chi la usa in azienda. Dal 2 agosto 2025 valgono le regole sui modelli di uso generale, la governance e le sanzioni. Dal 2 agosto 2026 scattano gli obblighi di trasparenza dell’articolo 50 e comincia l’applicazione vera e propria su divieti, modelli di uso generale, trasparenza e alfabetizzazione. Non è la data in cui «si applica tutto»: i sistemi ad alto rischio arrivano dopo, e il calendario è stato modificato in corsa dal pacchetto di semplificazione digitale sull’AI. Vale la pena ricontrollarlo sul sito della Commissione prima di prendere decisioni. Per alcuni sistemi ad alto rischio legati a prodotti regolamentati la scadenza è il 2 agosto 2027.',
        ],
        lista_punti: [
          '1 agosto 2024: entrata in vigore',
          '2 febbraio 2025: disposizioni generali, alfabetizzazione e pratiche vietate',
          '2 agosto 2025: modelli di uso generale, autorità nazionali, governance europea',
          '2 agosto 2026: obblighi di trasparenza dell’articolo 50, misure a sostegno dell’innovazione, e avvio dell’applicazione per modelli di uso generale, pratiche vietate, trasparenza e alfabetizzazione',
          '2 dicembre 2026: nuovi divieti su deepfake sessuali non consensuali e materiale pedopornografico, e termine transitorio per chi aveva già sul mercato sistemi che generano contenuti sintetici',
          '2 agosto 2027: ogni Stato membro deve avere almeno uno spazio di sperimentazione normativa operativo',
          '2 dicembre 2027: sistemi ad alto rischio elencati nell’allegato III',
          '2 agosto 2028: AI ad alto rischio incorporata in prodotti già regolati, allegato I',
        ],
      },
      {
      ...
      },
      {
        ...
        paragrafi: [
          ...
          'Sui contenuti generati artificialmente c’è un equivoco diffuso, e conviene disfarlo. L’obbligo di marcare gli output in formato leggibile da una macchina è del fornitore del sistema che li genera, cioè di chi produce il modello: non di chi lo usa per lavorare.',
          'Chi utilizza il sistema ha obblighi più circoscritti: dichiarare i deepfake, informare le persone esposte a riconoscimento delle emozioni o categorizzazione biometrica, ed etichettare i testi generati dall’AI pubblicati per informare il pubblico su questioni di interesse pubblico. Su quest’ultimo punto la Commissione precisa l’esenzione che riguarda quasi tutti: se il testo è passato da una revisione umana o da un controllo editoriale, l’etichetta non serve. Revisione umana significa che una persona con competenza e giudizio professionale ha esaminato davvero la sostanza del contenuto; un controllo ortografico non basta.',
          'Tradotto per una PMI che pubblica contenuti commerciali approvati da una persona prima di uscire: l’obbligo di etichettatura in genere non scatta. Restano invece il dovere di dichiarare l’assistente quando parla con i clienti e l’alfabetizzazione del personale, che sono in vigore dal febbraio 2025.',

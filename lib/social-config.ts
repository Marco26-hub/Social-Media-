...
export const PLATFORMS: Record<PlatformKey, PlatformConfig> = {
  instagram: {
    ...
    formati: [
      ...
      { id: 'IG-STORY', nome: 'Story',    desc: 'Story 24h verticale, pubblicata via Blotato', icon: Clock, formato: 'story', aspectRatio: '9:16', esempio: 'Dietro le quinte / novità', goal: 'Engagement quotidiano e presenza' },
    ],
  },
  facebook: {
    key: 'facebook',

...
import { GIORNI_PROVA, PIANI_SALA, SALA_NOTA_PREZZI, pianoSala } from '@/lib/ristoranti-listino'
...
export const SETTORI: Settore[] = [
  {
    ...
    notaPrezzi: `Riprese in salone ${PREZZI.video}. Gestione social ${PREZZI.presenza} o ${PREZZI.crescita}. Sito ${PREZZI.web}. Assistente telefonico ${PREZZI.voce}. Prezzi IVA esclusa.`,
    ...
    risultati: [
      ...
      { title: 'Quando sei in trattativa', text: 'La chiamata che arriva mentre chiudi un preventivo è coperta dai 600 minuti al mese del piano d’ingresso: orari, disponibilità e allestimenti approvati, poi la prova su strada in agenda. Il resto passa a te.' },
    ...
    cosaFacciamo: [
      ...
      { title: 'Dove finiscono le richieste', text: `La pagina di atterraggio è il modulo che trasforma un video in una richiesta di prova su strada, ${PREZZI.web} al netto dell’IVA. Moduli, statistiche e collegamento alle campagne sono inclusi.` },
      { title: 'Quando il salone è pieno', text: `L’assistente telefonico è chi tiene la linea quando siete tutti impegnati: canone ${PREZZI.voce} e 600 minuti compresi. Informa, fissa l’appuntamento e passa la chiamata quando la richiesta esce dalle regole.` },
      { title: 'Cosa non dice l’assistente', text: 'Permute, sconti e valutazioni restano fuori dalle risposte caricate nei 600 minuti del piano: l’assistente prende i dati e passa a una persona. Le regole di passaggio le scrivi tu in avvio.' },
    ...
    faq: [
      ...
      { q: 'Cosa può dire l’assistente telefonico su un veicolo in vendita?', a: 'L’assistente telefonico è limitato alle informazioni che carichi tu — orari, disponibilità, allestimenti, appuntamenti — e lavora sui 600 minuti al mese del piano d’ingresso, 10 ore di conversazioni. Valutazioni di permuta, sconti e trattative restano a una persona del salone secondo le regole scritte in avvio. Chi chiama sa dall’inizio di parlare con un assistente, perché non finge di essere un venditore.' },
      ...
      { q: 'Dove finiscono i contatti raccolti dal sito e dal telefono?', a: 'I contatti raccolti sono vostri e restano nei sistemi del salone: nei 600 minuti mensili l’assistente registra esito e riepilogo della chiamata, mentre l’audio non è attivo di base. Trattiamo solo ciò che serve al servizio attivato e non usiamo i materiali dei clienti per addestrare modelli. Accessi e cancellazioni si chiedono in qualsiasi momento, e la richiesta viene evasa senza costi.' },
  ...
  },
  {
    ...
    lead:
      'Una chiamata persa in salone è quasi sempre un appuntamento andato altrove, e il piano d’ingresso copre 600 minuti al mese, circa 200 conversazioni da tre minuti. Chi dirada le visite non lo annuncia: smette e basta.',
    ...
    segnali: ['Risponde a mani occupate', 'Ogni messaggio lo approvi tu', 'Riprese fra una piega e l’altra', '0% di commissione: i clienti restano tuoi'],
    risultati: [
      { title: 'Come non perdere una chiamata', text: 'Il telefono del salone è coperto anche durante un colore, di sera e nel giorno di chiusura, con i 600 minuti al mese del piano base. Chi chiama sente una voce e non tre squilli seguiti dalla segreteria.' },
    ...
    cosaFacciamo: [
      { title: 'Come risponde il telefono', text: `Il telefono del salone è un canone, ${PREZZI.voce}, con 600 minuti: l’assistente dice servizi, listino e orari che hai approvato tu, e fissa in agenda mentre sei con un cliente in poltrona.` },
      ...
      { title: 'Quando la settimana ha un buco', text: 'Il martedì mattina vuoto diventa una proposta pronta per chi è già in archivio. Il testo parte solo se ci metti il sì, e i 1000 messaggi del mese coprono anche gli spazi liberi, non solo i richiami.' },
    ...
    ciclo: [
      ...
      { number: '02', title: 'Come si prova', text: 'La prova è la fase in cui ascolti come risponde e leggi i messaggi tipo, prima che il numero del salone venga collegato ai 600 minuti del piano. Si corregge finché non ti convince: parole, listino, orari, modo di salutare. Nessuna chiamata reale entra prima del tuo via libera.' },
      { number: '03', title: 'Quando si collega', text: 'L’attivazione è il momento in cui il numero entra in esercizio e i 600 minuti mensili iniziano a coprire le chiamate. I messaggi ai clienti fermi restano in bozza e partono solo dopo il tuo sì, uno a uno o a gruppi.' },
    ...
    faq: [
      { q: 'Come risponde l’assistente mentre sto facendo un colore?', a: `L’assistente telefonico è un numero che risponde al posto tuo quando hai le mani occupate, con 600 minuti al mese compresi nel piano d’ingresso, ${PREZZI.voce}. Dà servizi, listino e orari che hai approvato, legge il calendario e fissa l’appuntamento nello spazio libero. Se la richiesta esce dalle regole, prende i dati e la passa a te, così la richiami quando ti fermi.` },
      ...
      { q: 'Come vengono contati i minuti del piano?', a: 'Il conteggio è sulla durata delle conversazioni gestite, non sul numero di chiamate ricevute: 600 minuti al mese valgono circa 200 conversazioni da tre minuti, cioè 10 ore di telefono. Oltre la soglia i minuti si pagano a consumo alla tariffa del tuo piano, senza rinegoziare il canone. Numero telefonico e traffico dell’operatore restano fuori dal canone e vengono indicati nella proposta.' },
      ...
      { q: 'Quanto costa attivare solo la risposta telefonica?', a: `Il telefono da solo è ${PREZZI.voce}, con 600 minuti compresi e un costo di avvio una tantum indicato nella proposta prima dell’attivazione. Il recupero clienti su WhatsApp è un servizio separato, ${PREZZI.agenda}, e si aggiunge quando vuoi senza rifare la configurazione. Molti saloni partono dal telefono, che è il buco più visibile, e valutano il resto dopo qualche mese.` },
      ...
      { q: 'Cosa succede se il cliente vuole parlare con una persona?', a: 'Il passaggio a te è previsto dalle regole scritte in avvio: l’assistente non insiste, prende nome, numero e motivo entro i 600 minuti del piano e chiude con una promessa di richiamo. Si può impostare come trasferimento immediato negli orari di apertura oppure come nota da leggere a fine giornata. Chi chiama sa di parlare con un assistente, perché lo dice nella prima frase.' },
    ],
    correlati: [
      { href: '/servizi/segretaria-telefonica-ai', label: 'Segretaria telefonica AI' },
  ...
  },
  {
    ...
    notaPrezzi: `Riprese ${PREZZI.video}. Gestione social ${PREZZI.presenza} o ${PREZZI.crescita}. Sito ${PREZZI.web}. Assistente telefonico ${PREZZI.voce}. Prezzi IVA esclusa.`,
    ...
    risultati: [
      ...
      { title: 'Quando siete fuori a mostrare', text: 'La richiesta che arriva durante una visita è raccolta dall’assistente entro i 600 minuti del canone base: informazioni generali, orari e appuntamento fissato. La segreteria telefonica non entra in gioco.' },
    ...
    cosaFacciamo: [
      ...
      { title: 'Quando l’ufficio è vuoto', text: `L’assistente telefonico è il presidio delle ore in cui siete tutti fuori: ${PREZZI.voce} e 600 minuti al mese, informazioni approvate e appuntamento a calendario. Il resto passa a un consulente.` },
    ...
    faq: [
      ...
      { q: 'Cosa cambia rispetto alla scheda sul portale?', a: `La scheda del portale è un confronto su prezzo e metri quadri, dove il nome dell’agenzia pesa poco; la pagina vostra, ${PREZZI.web}, raccoglie invece un contatto che resta vostro. Sul portale competete con chi ha lo stesso immobile a un prezzo più basso, sui vostri canali competete sul modo in cui lo mostrate. I due lavori convivono: non tocchiamo la pubblicazione sui portali, che resta al vostro gestionale.` },
      { q: 'Quali informazioni dà l’assistente su un immobile?', a: 'Le informazioni ammesse sono quelle generali che caricate voi — disponibilità per le visite, orari, zona, tipologia e stato dell’immobile — dentro i 600 minuti del canone base, cioè 10 ore al mese. Valutazioni, trattative sul prezzo, dati catastali e situazioni condominiali delicate restano a un consulente, e la chiamata viene passata secondo le regole scritte in avvio. Le domande ripetitive sono coperte, le negoziazioni no.' },
      { q: 'Quanto costa il sito di un’agenzia immobiliare?', a: `Il sito base è ${PREZZI.web}, canone che comprende hosting, manutenzione, design responsive e SEO tecnica essenziale — dominio e caselle di posta restano intestati a te e a tuo carico — e il progetto passa all’agenzia dopo 12 mesi. Funzioni avanzate, collegamenti al gestionale e sviluppi su misura vengono quotati a parte e approvati prima di ogni costo aggiuntivo. Il dominio resta intestato all’agenzia, così il sito non è mai ostaggio di un fornitore.` },
  ...
  },
  {
    ...
    risultati: [
      ...
      { title: 'Come si prende un preventivo', text: 'La richiesta di sopralluogo è raccolta dall’assistente nei 600 minuti del canone base, anche con le squadre tutte fuori. Prende referente, sede e tipo di servizio, e fissa la visita in calendario.' },
    ...
    cosaFacciamo: [
      ...
      { title: 'Quando l’ufficio è vuoto', text: `L’assistente telefonico è il filtro che prende le richieste mentre nessuno è in sede: ${PREZZI.voce} e 600 minuti al mese, con referente, sede e sopralluogo già fissato in agenda.` },
      { title: 'Dove arriva una richiesta', text: `Il sito è la pagina costruita per far arrivare richieste di preventivo, ${PREZZI.web}, con il progetto che passa all’impresa dopo 12 mesi. Moduli, statistiche di percorso e testi orientati al B2B.` },
    ...
    ciclo: [
      ...
      { number: '03', title: 'Come si risponde', text: 'La risposta è coperta dai 600 minuti mensili dell’assistente, 10 ore di telefono: chi chiama per un preventivo trova una voce, lascia referente e sede e ottiene un sopralluogo in calendario. Le richieste fuori regola arrivano in ufficio con la nota già scritta.' },
  ...
  },
  {
    ...
    notaPrezzi: `Assistente telefonico ${PREZZI.voce}. Agenda e recupero clienti ${PREZZI.agenda}. Gestione social ${PREZZI.presenza} o ${PREZZI.crescita}. Costi di avvio una tantum indicati prima dell’attivazione. Prezzi IVA esclusa.`,
    segnali: ['Risponde con la cabina occupata', 'Percorsi fermi segnalati ogni giorno', 'Testi scritti prima, inviati dopo', '0% di commissione: le clienti restano tue'],
    risultati: [
      ...
      { title: 'Come si copre la cabina', text: 'L’ora di trattamento è il buco in cui nessuno può rispondere: i 600 minuti compresi nel piano base coprono chi chiama in quella fascia. Informazioni approvate, orari liberi e appuntamento fissato.' },
    ...
    cosaFacciamo: [
      { title: 'Come risponde in cabina', text: `Il telefono in cabina è coperto da un canone, ${PREZZI.voce}, con 600 minuti compresi: trattamenti, durate e prezzi che hai approvato tu, orari liberi e appuntamento salvato dopo conferma.` },
    ...
    ciclo: [
      ...
      { number: '02', title: 'Come suonano le prove', text: 'Le prove sono registrazioni che ascolti prima di collegare il numero dell’istituto ai 600 minuti del piano, insieme ai testi tipo dei richiami. Si correggono parole, listino e modo di proporre un orario, finché non somigliano a come parli tu in cabina. Nessuna cliente vera entra prima.' },
      { number: '03', title: 'Quando si accende', text: 'La messa in linea è il passaggio finale: i 600 minuti coprono il telefono anche a cabina occupata e i 1000 invii inclusi aprono i richiami. I messaggi restano fermi in bozza finché non li approvi tu, uno per uno o a gruppi.' },
    ...
    faq: [
      { q: 'Cosa può dire l’assistente su un trattamento?', a: 'L’assistente dice solo le informazioni che hai approvato: servizi, durata di una seduta, prezzi di listino e disponibilità. Il canone base comprende 600 minuti al mese, cioè 10 ore di telefono. Ogni valutazione su pelle, controindicazioni, gravidanza o percorsi in corso resta a una persona del centro, e la chiamata viene passata secondo le regole scritte in avvio. Che si tratti di un assistente viene detto subito, non su richiesta.' },
  ...
  },
  {
    ...
    lead:
      'La prima informazione è la chiamata più ripetuta di una clinica — che cosa fate, quanto dura, quando c’è posto — e il piano più alto arriva a 3000 minuti al mese. La valutazione clinica non passa mai da un sistema automatico.',
    ...
    segnali: ['Nessuna risposta clinica automatica', 'Regole scritte prima dell’attivazione', 'Trascrizioni consultabili dal personale', '0% di commissione: i pazienti restano vostri'],
    risultati: [
      { title: 'Cosa alleggerisce la reception', text: 'Le domande ripetitive sono la quota di chiamate che non richiede un medico, e i piani coprono da 300 fino a 3000 minuti al mese. Chi è allo sportello torna a occuparsi dei pazienti presenti in sede.' },
      { title: 'Come si separa il clinico', text: 'La regola è scritta prima dell’attivazione: 2 percorsi distinti, uno informativo gestito dall’assistente e uno clinico trasferito a una persona. Nessuna zona grigia lasciata al caso.' },
    ...
    cosaTitolo: 'Prima le regole, poi la tecnologia.',
    cosaIntro:
    ...
    cosaFacciamo: [
      { title: 'Quali informazioni dà al telefono', text: `Le prime informazioni sono servizi, sedi, orari e disponibilità approvati dalla direzione, entro i minuti del piano scelto, da 600 a 3000 al mese. Canone ${PREZZI.voce}. Nessun contenuto clinico, mai.` },
      ...
      { title: 'Dove atterrano le richieste', text: `Il sito della clinica è l’insieme di pagine che spiegano i percorsi e raccolgono richieste, ${PREZZI.web}, con il progetto che passa alla clinica dopo 12 mesi. Moduli, statistiche e struttura leggibile.` },
    ...
    ciclo: [
      { number: '01', title: 'Cosa può dire', text: 'Il documento di avvio elenca ciò che l’assistente può dire e ciò che deve trasferire, scritto con la direzione sanitaria prima di configurare i 600 o i 3000 minuti del piano. Servizi, sedi, orari e disponibilità entrano; controindicazioni ed esiti restano fuori.' },
      { number: '02', title: 'Come si prova su casi reali', text: 'Le prove sono conversazioni registrate su casi che la clinica riceve davvero, ascoltabili prima di collegare il numero ai minuti del piano, da 600 a 3000 al mese. Si corregge finché ogni risposta rispetta le regole: una frase vicina al confine clinico viene riscritta.' },
      { number: '03', title: 'Quando il numero entra in linea', text: 'L’attivazione è il momento in cui i minuti del piano entrano in esercizio, da 600 a 3000 al mese secondo i volumi della clinica. Prime informazioni e prenotazioni vengono gestite, le richieste cliniche trasferite, e le prime settimane restano sotto osservazione ravvicinata.' },
      { number: '04', title: 'Cosa si rivede ogni mese', text: 'Il controllo mensile è la rilettura di esiti, trascrizioni e conversazioni segnalate dal personale autorizzato, sui minuti effettivamente usati fra i 300 e i 3000 del piano. È il punto in cui una risposta che non convince viene cambiata: la qualità è parte del servizio, non un extra da chiedere.' },
    ],
    faq: [
      { q: 'Cosa risponde l’assistente a una domanda medica?', a: 'La risposta è sempre la stessa: nessuna informazione clinica e passaggio a una persona della clinica, perché la domanda medica è uno dei 3 casi di trasferimento previsti dalle regole. L’assistente resta dentro i servizi offerti, le sedi, gli orari e le disponibilità che avete approvato, entro i minuti del piano scelto. Domande su controindicazioni, esiti attesi, farmaci o percorsi in corso vengono trasferite senza tentativi di risposta parziale.' },
      { q: 'Come restano protetti i dati dei pazienti?', a: 'Il titolare del trattamento resta la clinica, anche con 2 o più sedi collegate. Trattiamo solo i dati necessari al servizio attivato, e nessun materiale della clinica viene usato per addestrare sistemi. Le registrazioni audio non sono attive di base e possono essere abilitate solo con regole privacy adeguate, decise da voi. Trascrizioni ed esiti restano consultabili dal personale autorizzato.' },
      { q: 'Quali sedi e reparti si possono gestire?', a: 'La gestione multi sede è prevista con percorsi diversi per sede o reparto, fino ai 3000 minuti mensili del piano più alto, 50 ore di conversazioni. Cambiano orari, servizi disponibili e regole di trasferimento, mentre il divieto di risposta clinica resta identico ovunque. Numeri aggiuntivi, assistenti aggiuntivi e collegamenti fra sistemi vengono quotati separatamente, dopo aver visto come siete organizzati.' },
      ...
      { q: 'Quanto costa gestire volumi di chiamate alti?', a: `Il canone è ${PREZZI.voce} per il piano base con 600 minuti compresi e sale con i minuti inclusi, fino ai 1500 mensili del piano pensato per cliniche e reparti. Oltre soglia i minuti si pagano a consumo alla tariffa del piano, senza rinegoziare il contratto. Numero telefonico, traffico dell’operatore e sviluppi su misura restano fuori dal canone e sono indicati nella proposta prima della firma.` },
      ...
      { q: 'Cosa succede a una richiesta urgente?', a: 'L’urgenza è uno dei 3 casi di trasferimento immediato definiti nelle regole, insieme alla domanda clinica e alla richiesta non prevista. L’assistente non valuta la gravità: raccoglie i dati essenziali e passa la chiamata secondo le regole che avete scritto. Fuori orario, il percorso di emergenza indicato dalla clinica viene comunicato senza interpretazioni.' },
  ...
  },
  {
    ...
    risultati: [
      ...
      { title: 'Cosa resta dei preventivi fermi', text: 'Le cure preventivate e mai iniziate sono la parte più muta del lavoro di uno studio. Tornano fra le priorità del giorno con data e motivo, dentro i 1000 invii mensili, invece di restare in fondo al gestionale.' },
    ],
    ...
    cosaFacciamo: [
      { title: 'Quando la reception ha la fila', text: `L’assistente telefonico è la linea che regge prenotazioni, spostamenti e disdette con i 600 minuti del canone, ${PREZZI.voce}, mentre allo sportello c’è già un paziente da seguire.` },
      ...
      { title: 'Dove si chiede una prima visita', text: `Il sito dello studio è l’insieme di pagine che spiegano i percorsi e raccolgono richieste di prima visita, ${PREZZI.web}: dopo 12 mesi di canone il progetto è dello studio. Moduli e statistiche compresi.` },
      { title: 'Quando passa allo studio', text: 'Dolore, urgenze e domande cliniche sono i 3 casi che vanno a una persona secondo le regole che scrivete voi. L’assistente non interpreta un sintomo: prende i dati e passa, anche fuori orario.' },
    ],
    ciclo: [
      ...
      { number: '02', title: 'Come si tara il tono', text: 'La taratura è la fase in cui leggete i testi tipo e ascoltate le risposte telefoniche dei 600 minuti del canone, e correggete prima che il numero venga collegato. Un richiamo di igiene scritto male suona come una promozione: si riscrive finché non suona come lo studio che lo manda.' },
    ...
    faq: [
      { q: 'Come funzionano i richiami di igiene?', a: 'Il richiamo di igiene si prepara da solo e si invia a mano. Ogni giorno il sistema legge agenda e storico, individua chi ha raggiunto la scadenza che avete deciso e scrive il messaggio, dentro i 1000 invii mensili. Il motivo resta scritto a fianco di ogni nome, così la segreteria sa perché quella persona è in elenco. Nulla parte prima del via libera, e di ogni invio resta traccia.' },
      { q: 'Cosa risponde l’assistente a chi ha dolore?', a: 'Il dolore è fra i 3 casi che passano immediatamente a una persona: nessuna valutazione, nessun consiglio, gestione secondo le regole che avete scritto. Entro i 600 minuti del canone base l’assistente gestisce prenotazioni, spostamenti, disdette e informazioni generali già approvate. Se lo studio è chiuso, comunica le indicazioni che avete predisposto, senza aggiungere interpretazioni proprie.' },
      ...
      { q: 'Quanto costa il servizio di agenda e richiami?', a: `Il canone è ${PREZZI.agenda} per la parte di agenda e richiami, con 1000 invii compresi nel mese, più un costo di avvio una tantum indicato nella proposta prima dell’attivazione. La risposta telefonica è separata e parte ${PREZZI.voce} con 600 minuti, 10 ore di telefono al mese. I costi applicati dalle piattaforme di messaggistica restano fuori dal canone, perché non li incassiamo noi.` },
      { q: 'Come si collega il gestionale dello studio?', a: 'Il gestionale non si cambia: se funziona resta dov’è. Il collegamento con gli altri strumenti si quota dopo aver visto quale delle 2 strade è percorribile, interfaccia diretta o esportazione periodica. Anche le esportazioni sono sufficienti per costruire le priorità del giorno. Nessuna migrazione di archivio viene fatta senza una richiesta esplicita dello studio.' },
      { q: 'Dove restano i dati dei pazienti?', a: 'I dati restano dello studio, che rimane titolare del trattamento. Quello che passa dai nostri sistemi non finisce in nessun addestramento, e ognuno dei 1000 invii mensili lascia traccia di destinatario, testo ed esito. Trattiamo il minimo necessario a far funzionare richiami e risposta telefonica, e ogni accesso è limitato al personale autorizzato. Esportazione e cancellazione si chiedono in qualsiasi momento, senza costi.' },
  ...
  },
  {
    ...
    risultati: [
      ...
      { title: 'Come si copre la seduta', text: 'L’ora sul lettino è il momento in cui il telefono resta scoperto: i 600 minuti del piano d’ingresso coprono chi chiama mentre siete con un paziente. Orari, disponibilità e seduta fissata.' },
    ...
    cosaFacciamo: [
      { title: 'Quando siete sul lettino', text: `L’assistente telefonico è la voce che risponde durante le sedute: 600 minuti compresi, canone ${PREZZI.voce}. Dà orari, disponibilità e informazioni generali approvate, e fissa dopo la conferma.` },
    ...
    faq: [
      { q: 'Come si accorge il sistema che un ciclo è interrotto?', a: 'Il ciclo interrotto si riconosce confrontando le sedute previste con quelle prenotate. Se ne restano da fare e non c’è un appuntamento futuro, il paziente torna fra le priorità del giorno, dentro il tetto di 1000 messaggi mensili. Il controllo gira ogni giorno sull’archivio dello studio, non su liste esterne, e la ragione del contatto resta scritta accanto a ogni nome. Chi ha concluso il percorso non viene segnalato.' },
      { q: 'Cosa può dire l’assistente sul dolore di un paziente?', a: 'L’assistente non dà risposte cliniche: risponde su orari, disponibilità, sedi e informazioni generali che avete approvato, entro i 600 minuti del piano d’ingresso, e fissa gli appuntamenti. Valutazioni sul dolore, sull’andamento del percorso, sugli esercizi da fare a casa o sulla necessità di una visita restano a un professionista dello studio. La chiamata viene passata secondo le regole scritte in avvio.' },
      { q: 'Quando è il momento giusto per ricontattare?', a: 'Il momento lo decidete voi in avvio: dopo quanti giorni segnalare un ciclo fermo, in quali fasce orarie scrivere e quando è meglio lasciar perdere. Il tetto resta di 1000 messaggi al mese. Il sistema propone, non decide: prepara il testo e lo mette in coda, e un professionista sceglie se e quando inviarlo. Nella nostra esperienza il messaggio funziona quando ricorda un percorso concordato, non quando somiglia a un’offerta.' },
      { q: 'Quali regole di contatto restano allo studio?', a: 'Le regole sono vostre e si scrivono prima dell’attivazione: chi contattare, dopo quanto tempo, con quale tono e chi escludere per sempre. Ogni scelta vale su tutti i 1000 messaggi del mese. Il testo resta in bozza finché non lo approvate, e ogni invio lascia traccia di destinatario, motivo ed esito. Cambiare una regola richiede una richiesta, non una riconfigurazione a pagamento.' },
      { q: 'Quanto costa partire solo dai richiami?', a: `Il piano di agenda e richiami è ${PREZZI.agenda} con 1000 messaggi mensili compresi, più un avvio una tantum scritto nella proposta prima dell’attivazione. La risposta telefonica è un servizio separato, ${PREZZI.voce}, con 600 minuti al mese: 10 ore di conversazioni, aggiungibili in seguito senza rifare la configurazione già pagata. I canoni sono al netto dell’IVA.` },
      { q: 'Chi è il titolare dei dati dei pazienti?', a: 'Il titolare del trattamento è lo studio, sempre: i dati dei pazienti restano vostri. Trattiamo solo il minimo che il servizio richiede, e niente di quello che passa dai nostri sistemi viene riutilizzato per addestrare modelli. Informazioni cliniche o diagnostiche non entrano nei messaggi, che parlano di appuntamenti e di percorsi già concordati. Esportazione e cancellazione si chiedono in qualsiasi momento.' },
  ...
  },
  {
    ...
    lead:
      'La chiamata tipo di un’officina è fatta di tre domande — quando c’è posto, quanto viene, a che ora chiudete — e 600 minuti al mese ne coprono circa 100. Nessuna richiede te, ma nessuna si può perdere.',
    ...
    risultati: [
      { title: 'Come si risponde sotto il ponte', text: 'Le domande su orari, disponibilità e tempi sono gestite senza fermare l’intervento in corso, dentro i 600 minuti del canone base. Il mezzo resta sul ponte e la chiamata trova comunque una voce.' },
      ...
      { title: 'Dove arriva un preventivo di sera', text: `La richiesta delle 22 è raccolta dal sito, che è online ${PREZZI.web}, e dopo 12 mesi di canone il progetto è tuo. Chi cerca un preventivo trova un modulo, non un numero che squilla a vuoto.` },
    ],
    ...
    cosaFacciamo: [
      { title: 'Cosa dice al telefono', text: `L’assistente telefonico è il centralino che risponde con le mani nel motore: 600 minuti compresi, canone ${PREZZI.voce}. Dice orari, servizi, tempi indicativi e disponibilità approvati da te.` },
      ...
      { title: 'Dove si chiede un preventivo', text: `Il sito dell’officina è la pagina che raccoglie richieste di preventivo e appuntamento anche a saracinesca chiusa, ${PREZZI.web}. Moduli, statistiche di percorso e numeri di contatto in evidenza.` },
    ...
    ciclo: [
      { number: '01', title: 'Quali domande ricevi', text: 'Il primo passo è mettere per iscritto le 3 domande che senti ogni giorno: quando c’è posto, quanto viene, a che ora chiudete. Insieme ai tempi e ai costi indicativi che sei disposto a dire al telefono. Da quelle risposte nasce la configurazione, e ciò che non è scritto non viene detto.' },
      { number: '02', title: 'Come si prova la voce', text: 'La prova è l’ascolto delle risposte su casi reali dell’officina, prima che il numero venga collegato ai 600 minuti del piano. Si correggono parole, tempi e modo di proporre l’appuntamento: se una risposta ti sembra sbagliata, si riscrive in quel momento invece di scoprirlo con un cliente vero.' },
      { number: '03', title: 'Come entra in esercizio', text: 'L’attivazione è la messa in linea dei 600 minuti mensili, circa 200 conversazioni da tre minuti, con il numero collegato come hai deciso. Le chiamate trovano risposta anche con il mezzo sul ponte, e di ognuna restano esito e riepilogo da leggere quando ti fermi.' },
    ...
    faq: [
      { q: 'Cosa può dire l’assistente su un preventivo?', a: 'Il preventivo è e resta una tua valutazione: l’assistente dà solo i costi indicativi che hai caricato tu, raccoglie la richiesta e fissa l’appuntamento in accettazione, dentro i 600 minuti del canone base. Una cifra detta al telefono su un guasto non visto diventa un’aspettativa difficile da correggere quando il mezzo è sul ponte. Chi chiama lascia targa, modello e motivo, così quando richiami sai già di che cosa si parla.' },
      { q: 'Come funzionano i promemoria delle scadenze?', a: 'Il promemoria di scadenza nasce dallo storico degli interventi, dentro i 1000 invii mensili. Ogni giorno il sistema trova chi si avvicina a un tagliando, a una revisione o a una manutenzione, e prepara il messaggio con il motivo. Il testo è pronto, ma parte solo dopo il tuo via libera. Chi non vuole più ricevere promemoria viene escluso in modo permanente.' },
      { q: 'Quali chiamate vengono passate a te?', a: 'Le chiamate passate sono quelle che escono dalle regole scritte in avvio: guasti da valutare, contestazioni e richieste che non hai caricato fra le risposte dei 600 minuti del piano. L’assistente non improvvisa una risposta tecnica: prende nome, numero e motivo e ti lascia la nota, oppure trasferisce subito la chiamata negli orari che decidi tu. Il resto lo gestisce da solo, senza farti scendere dal ponte.' },
      { q: 'Quanto costa avere l’assistente al telefono?', a: `Il canone è ${PREZZI.voce} con 600 minuti compresi, circa 200 conversazioni da tre minuti: 10 ore di chiamate al mese, più un costo di avvio una tantum indicato nella proposta. I minuti oltre soglia si pagano a consumo alla tariffa del piano, senza rinegoziare il contratto. Numero telefonico e traffico dell’operatore restano separati dal canone, perché sono costi di terzi che non incassiamo noi.` },
      { q: 'Come si collega il numero dell’officina?', a: 'Il collegamento è una deviazione di chiamata verso il numero dell’assistente, oppure un numero dedicato che affianca il tuo: la scelta si fa in avvio, sui 600 minuti del piano base, e si può cambiare. Chi ha un solo numero di solito devia le chiamate quando l’officina è chiusa o quando nessuno risponde entro qualche squillo. Il numero storico dell’officina resta tuo, intestato a te.' },
      { q: 'Cosa serve per attività diverse da un’officina?', a: 'Il meccanismo è identico per chi lavora su appuntamento e ha scadenze periodiche: impianti, manutenzioni, assistenza tecnica, installatori. Restano le stesse 2 soglie, 600 minuti al mese di telefono e 1000 invii per i richiami. Cambiano le parole caricate nel pannello, non il funzionamento. La configurazione si adatta al vocabolario del tuo mestiere durante l’avvio.' },
      { q: 'Dove si leggono le chiamate ricevute?', a: 'Il registro chiamate è il posto dove trovi esito, riepilogo e, secondo il piano attivo, la trascrizione delle conversazioni gestite nei 600 minuti del mese. È quello che guardi a fine giornata per sapere che cosa è successo mentre eri sotto il ponte: chi ha chiamato, che cosa voleva, che appuntamento è stato fissato. Da lì si correggono anche le risposte che non ti convincono.' },
  ...
  },
  {
    ...
    descrizioneSeo:
      'Il cliente inquadra il QR al tavolo, ordina e paga dal telefono. Per ristoranti, pizzerie e bar: prenotazioni, menu e ordini live nel pannello di sala, più sito e contenuti social.',
    eyebrow: 'Ristoranti, pizzerie e bar',
    ...
    servizio: 'Sistema di ordine e pagamento al tavolo per ristoranti e pizzerie',
    tipoServizio: 'Ordine e pagamento al tavolo via QR, prenotazioni, sito e contenuti per ristoranti, pizzerie e bar',
    promessa:
      'Ordine e pagamento passano dal telefono del cliente, le prenotazioni entrano in un posto solo e sull’incassato non tratteniamo nessuna percentuale. Nessuna promessa sul numero di coperti.',
    notaPrezzi: SALA_NOTA_PREZZI,
    segnali: ['Nessuna percentuale trattenuta sull’incassato', 'Ordine e pagamento dal QR al tavolo', 'Il fornitore di pagamento resta il tuo'],
    risultati: [
      ...
      { title: 'L’incasso resta intero', text: 'Il denaro arriva sul conto del locale e noi non tratteniamo nessuna percentuale: chi vende un canone basso con l’uno o due per cento sopra incassa lui e ti gira il resto.' },
    ],
    cosaTitolo: 'Che cosa mettiamo in sala, e intorno alla sala.',
    cosaIntro:
      'Il sistema copre il giro completo del cliente: prenota, si siede, ordina, paga, lascia una recensione e riceve la fattura. Intorno ci sono il sito e i contenuti che lo hanno fatto arrivare.',
    cosaFacciamo: [
      ...
      { title: 'Pagamento dal telefono', text: 'Carta, Apple Pay, Google Pay o Satispay. L’incasso arriva sul conto del locale e noi non tratteniamo nessuna percentuale.' },
      { title: 'Conto alla romana', text: 'Ognuno paga i propri piatti dal proprio telefono. Il conto si chiude da sé quando è tutto saldato, senza dividere a mente al banco.' },
      { title: 'Allergeni a norma', text: 'Campo dedicato su ogni piatto, come chiede il Reg. UE 1169/2011. Il cliente li legge da solo, senza chiedere a chi serve.' },
      { title: 'Menu che cambi tu', text: 'Piatti, prezzi e disponibilità si aggiornano dal pannello: finito il branzino lo togli e sparisce da tutti i tavoli nello stesso istante.' },
      { title: 'Prenotazioni in un posto solo', text: 'Pagina di prenotazione per sito e social, controllo della capienza, promemoria il giorno prima e link per disdire: il tavolo dimenticato si libera in tempo.' },
      { title: 'Recensioni chieste al tavolo', text: 'Appena finito di mangiare, col telefono già in mano. Chi non è contento te lo dice stasera, invece che su Google fra una settimana.' },
      { title: 'Numero di ritiro al banco', text: 'Pizza al taglio, piadineria, gastronomia: chi ordina prende un numero che riparte da uno ogni giorno, e sullo schermo del banco vedi cosa chiamare.' },
      { title: 'Formula a prezzo fisso', text: 'All you can eat con prezzo a persona, pranzo e cena separati e ordinazioni a ondate: senza, un tavolo da sei manda ottanta piatti in tre minuti.' },
      { title: 'Fattura elettronica', text: 'Il cliente inserisce i dati dal tavolo e la fattura parte allo SDI tramite un intermediario accreditato che colleghi tu.' },
      { title: 'Il tuo marchio, non il nostro', text: 'Logo, colori e dati del locale su ogni pagina che vede il cliente. Il nostro nome non compare da nessuna parte.' },
      { title: 'Menu leggibile da Google e dalle AI', text: 'La pagina pubblica del menu ha dati strutturati: è quello che motori di ricerca e assistenti leggono quando qualcuno chiede dove si mangia.' },
      { title: 'Accessi separati', text: 'Titolare, responsabile, sala e cucina vedono solo il proprio: chi è in sala non tocca incassi e dati fiscali.' },
      { title: 'Menu importato, non ribattuto', text: 'Da file CSV o TSV, oppure dalla cassa Tilby. Il primo giorno non si passa a ricopiare duecento piatti a mano.' },
      { title: 'Il sito del locale', text: `Menu, prenotazione e posizione su una pagina che si apre veloce dal telefono, ${PREZZI.web}.` },
    ...
    ciclo: [
      ...
      { number: '02', title: 'Configurazione', text: 'Carichiamo il menu da file o dalla cassa, generiamo i QR, colleghiamo il vostro conto di incasso e mettiamo il vostro marchio sulle pagine.' },
      { number: '03', title: 'Prova in sala', text: `Si parte da pochi tavoli con il personale presente, finché il giro non fila. La prova dura ${GIORNI_PROVA} giorni e non chiede la carta.` },
      { number: '04', title: 'A regime', text: 'Il pannello mostra ordini, prenotazioni e incassi, e il menu lo aggiornate voi.' },
    ],
    faq: [
      { q: 'Quanto costa il sistema di sala?', a: `${PIANI_SALA.map(p => `${p.nome} ${euro(p.canoneCents / 100)} al mese`).join(', ')}. Sull’annuale due mesi sono in omaggio. L’attivazione si paga una sola volta — ${euro(pianoSala('prenotazioni').attivazioneCents / 100)} per le sole prenotazioni, ${euro(pianoSala('ordini').attivazioneCents / 100)} dove ci sono anche gli ordini — e comprende menu caricato, QR pronti da stampare, incasso collegato e marchio configurato. Prezzi IVA esclusa.` },
      { q: 'Trattenete una percentuale sull’incassato?', a: 'No. Il denaro non passa da noi: i pagamenti con carta arrivano sul conto del locale dal primo istante e le commissioni della carta le paghi al tuo fornitore. Chi ti offre un canone basso con una percentuale unica sta incassando lui e girandoti il resto: a volumi bassi a volte conviene, ma perdi il rapporto diretto — non negozi la tariffa e non cambi fornitore senza cambiare gestionale.' },
      { q: 'Devo cambiare il POS che ho già?', a: 'No. Se hai un terminale e un acquirer che ti fa una tariffa buona, tienili: il conto si chiude segnando l’incasso sul tuo terminale e il tavolo si libera lo stesso. Il fornitore di pagamento resta una tua scelta.' },
      ...
      { q: 'Posso comprare solo le prenotazioni?', a: `Sì. I due moduli si comprano separati: le sole prenotazioni costano ${euro(pianoSala('prenotazioni').canoneCents / 100)} al mese e funzionano da sole, senza il gestionale di sala. È la scelta di chi riempie a telefono ma vuole una pagina dove farsi prenotare dal sito e dai social.` },
      { q: 'Che cosa serve per partire?', a: 'Un conto per incassare intestato al locale, i dati fiscali, il menu — da file o scritto nel pannello — e una stampa dei QR, uno per tavolo. Per la fattura elettronica serve in più un intermediario SDI accreditato; per il collegamento alla cassa Tilby, l’adesione al loro programma per sviluppatori.' },
      { q: 'Si vede il vostro nome sulle pagine dei clienti?', a: 'No. Logo, colori e dati sono quelli del locale su ogni pagina che vede il cliente: menu, conto, prenotazione e recensione. Il nostro nome non compare da nessuna parte.' },
      { q: 'Emette la fattura elettronica?', a: 'Sì, quando il cliente la chiede: inserisce i dati dal tavolo e il documento viene trasmesso allo SDI attraverso un intermediario accreditato, quindi non resta un modulo da compilare a mano il giorno dopo.' },
      ...
      { q: 'Il personale deve imparare un programma nuovo?', a: 'Il pannello serve a guardare e correggere, non a lavorare tutto il giorno: ordini in corso, prenotazioni, tavoli e menu. Gli accessi sono separati per ruolo, quindi chi è in sala vede la sala e non gli incassi.' },
      ...
      { q: 'Posso provarlo prima di decidere?', a: `Sì, ${GIORNI_PROVA} giorni e senza carta. Si carica il vostro menu, si stampano i QR e si fa provare il servizio a un tavolo vero: si capisce sui vostri piatti, non su un esempio generico.` },
    ],
    correlati: [
  ...
  },
  {
    ...
    descrizioneSeo:
      'Parti con un sito per la gelateria da 19,90 €/mese. Aggiungi menu QR, gusti e allergeni aggiornabili, ordini WhatsApp, contenuti e automazioni.',
    eyebrow: 'Gelaterie',
    h1: 'Fatti trovare. Mostra i gusti. Ricevi gli ordini.',
    lead:
      `Puoi partire con un sito essenziale da ${CANONE.web}. È il punto d’ingresso, non il progetto completo: menu QR, gusti e allergeni aggiornabili, ordini WhatsApp, contenuti e automazioni si aggiungono quando servono davvero.`,
    ...
    promessa:
      'Inizi dalla presenza online e costruisci per gradi il sistema della gelateria. Ogni modulo ha un compito preciso, un prezzo dichiarato e può essere aggiunto senza rifare il lavoro da capo.',
    notaPrezzi: `Sito essenziale ${PREZZI.web}. Menu QR e ordini ${euro(pianoSala('ordini').canoneCents / 100)} al mese, con attivazione una tantum di ${euro(pianoSala('ordini').attivazioneCents / 100)} e ${GIORNI_PROVA} giorni di prova senza carta. Gestione social ${PREZZI.presenza} o ${PREZZI.crescita}; riprese prodotto ${PREZZI.video}. Prezzi IVA esclusa.`,
    prezzoPrincipale: {
      label: 'Menu QR + ordini',
      valore: String(pianoSala('ordini').canoneCents / 100),
      cadenza: '/mese',
    },
    offertaIngresso: {
      label: 'Per iniziare online',
      prezzo: CANONE.web.replace(' € al mese', ''),
      cadenza: '/mese',
      testo: 'Landing professionale mobile-first con hosting e manutenzione del progetto base. Il sito diventa tuo dopo 12 mesi; menu QR e servizi di crescita restano moduli separati.',
      href: '/servizi/siti-e-commerce',
      cta: 'Vedi il sito da 19,90 €',
    },
    segnali: ['Gusti e disponibilità aggiornabili', 'Allergeni visibili dal QR', 'Ordini già compilati su WhatsApp'],
    risultati: [
    ...
    cosaTitolo: 'Da una presenza essenziale a un sistema completo.',
    cosaIntro:
      `Il sito da ${CANONE.web} ti rende presente e contattabile. Da lì puoi aggiungere gli strumenti che riducono il lavoro al banco, portano nuove richieste e fanno tornare chi ha già acquistato.`,
    cosaFacciamo: [
      { title: 'Sito essenziale', text: `Orari, posizione, contatti, prodotti principali e WhatsApp su una pagina veloce da telefono, ${PREZZI.web}. È il punto di partenza, non comprende menu QR o ordini.` },
    ...
    ciclo: [
      { number: '01', title: 'Presenza', text: `Partiamo dalla pagina essenziale da ${CANONE.web}: informazioni chiare, telefono, mappa e WhatsApp. È il gancio per essere trovati e misurare le prime richieste.` },
      { number: '02', title: 'Operatività', text: `Aggiungiamo menu QR e ordini a ${euro(pianoSala('ordini').canoneCents / 100)} al mese quando serve alleggerire il banco. Gusti, prezzi e allergeni si aggiornano dal pannello.` },
      { number: '03', title: 'Acquisizione', text: 'Foto, video, social e campagne portano persone sulle pagine giuste: non solo visibilità, ma richieste collegate a prodotti e promozioni precise.' },
      { number: '04', title: 'Relazione', text: 'Fidelity, compleanni e richiami stagionali fanno tornare i clienti già acquisiti. Si attivano quando il flusso di vendita è pronto a usarli.' },
    ],
    faq: [
      ...
      { q: 'Quanto costa il sistema per una gelateria?', a: `Il sito essenziale parte da ${CANONE.web}. Il modulo Menu QR e ordini costa ${euro(pianoSala('ordini').canoneCents / 100)} al mese, come il modulo equivalente per i ristoranti, con ${euro(pianoSala('ordini').attivazioneCents / 100)} di attivazione una tantum e ${GIORNI_PROVA} giorni di prova senza carta. Social, riprese e automazioni sono servizi separati: scegli solo quelli utili e approvi ogni costo prima dell’avvio.` },
  ...
  },
  {
    ...
    cosaFacciamo: [
      ...
      { title: 'Il sito che porta chiamate', text: `Una pagina che dice che cosa fai, dove intervieni e come chiamarti, costruita per il telefono, ${PREZZI.web}.` },
    ...
    faq: [
      { q: 'Funziona anche senza campo in cantina?', a: 'Sì. Il rapporto si compila anche con una connessione lenta. Le foto vengono compresse sul telefono prima di partire e il testo si salva mentre scrivi, così una cantina o un tunnel non fanno perdere il lavoro già fatto.' },
      ...
      { q: 'Quanto costa mettere in piedi tutto?', a: `Il modulo di intervento è su preventivo, perché dipende dagli operatori e dai modelli di scheda. Il sito è ${PREZZI.web} e l’assistente telefonico ${PREZZI.voce}, con il costo di avvio indicato prima dell’attivazione.` },
 ...
 */
/**
 * Prezzo d'ingresso di una pagina di settore, letto dalla nota prezzi.
 *
 * Legge entrambe le convenzioni, perche' la nota italiana scrive «199 €» e
 * quella inglese «€199»: cercando solo la prima, tutte e undici le pagine
 * inglesi mostravano «On request» al posto della cifra, cioe' la pagina piu'
 * commerciale del sito nascondeva il prezzo proprio a chi non parla italiano.
 * La virgola decimale e' italiana («19,90»), il punto e' inglese («19.90»).
 */
export function prezzoMinimoSettore(settore: Settore): string | undefined {
  const numeri = [
    ...settore.notaPrezzi.matchAll(/([0-9]+(?:[.,][0-9]+)?)\s*€/g),
    ...settore.notaPrezzi.matchAll(/€\s*([0-9]+(?:[.,][0-9]+)?)/g),
  ]
  const valori = numeri
    .map(m => parseFloat(m[1].includes(',') ? m[1].replace('.', '').replace(',', '.') : m[1]))

...
export const SETTORI: Settore[] = [
  ...
  },
  {
    ...
    promessa:
      'Aziende in target da contattare, richieste che non restano senza risposta e ogni intervento chiuso sul posto con foto e firma del cliente. Nessuna promessa su contratti o appalti.',
    ...
    segnali: ['Sito, modulo di intervento e pannello insieme', 'Rapporto firmato dal cliente sul posto', 'Aziende verificate su fonti pubbliche'],
    risultati: [
      ...
      { title: 'Contestazioni che finiscono', text: 'Foto, checklist e firma del cliente stanno nello stesso rapporto: la discussione su che cosa è stato fatto si chiude con un documento.' },
    ],
    cosaTitolo: 'Che cosa facciamo per un’impresa di pulizia.',
    cosaIntro:
      'Qui il marketing conta meno del processo: trovare le aziende giuste, rispondere in fretta e dimostrare che il lavoro è stato fatto. Il pacchetto mette insieme le tre cose — sito, modulo di intervento e pannello di gestione.',
    cosaFacciamo: [
      ...
      { title: 'Rapporto firmato sul posto', text: 'L’operatore compila l’intervento dal telefono su una checklist già pronta, allega le foto e raccoglie la firma sua e del cliente.' },
      { title: 'PDF e invio immediato', text: 'A fine intervento esce il rapporto in PDF, che parte via email, WhatsApp o Telegram senza passare dall’ufficio.' },
      { title: 'Ore contate da sole', text: 'Entrata, uscita e pausa diventano il totale delle ore: niente somme a mano sul foglio del venerdì.' },
      { title: 'Approvato o contestato', text: 'Ogni rapporto ha uno stato — bozza, inviato, ricevuto, approvato o contestato — quindi si sa sempre a che punto è.' },
      { title: 'Pannello di gestione', text: 'Da amministratore vedi la giornata, filtri per operatore, cliente o data, approvi o contesti, e gestisci immobili e squadre.' },
    ...
    ciclo: [
      ...
      { number: '04', title: 'Esecuzione', text: 'L’intervento si chiude sul posto con foto e firme, e il rapporto arriva al cliente prima che la squadra risalga in furgone.' },
    ],
    faq: [
      { q: 'Che cos’è il modulo di intervento tecnico?', a: 'È l’applicazione con cui la squadra chiude l’intervento sul posto: checklist precompilata dal modello del cliente, foto, note sulle anomalie, ore calcolate da entrata e uscita, firma dell’operatore e del cliente. Alla fine genera il rapporto in PDF e lo invia via email, WhatsApp o Telegram. Si installa sul telefono come un’applicazione e funziona anche con una connessione lenta, perché le foto vengono compresse prima di partire.' },
      { q: 'E chi sta in ufficio che cosa vede?', a: 'Un pannello con la giornata — rapporti, ore, pendenti, contestati — e i filtri per data, operatore, cliente e stato. Da lì si approva o si contesta un rapporto, e si gestiscono immobili, clienti, squadre e modelli di checklist.' },
      { q: 'Posso vedere com’è fatto prima di comprarlo?', a: 'Sì. Abbiamo un esempio completo online — sito, modulo di intervento e pannello di gestione montati insieme — costruito su un’impresa che lavora sul turnover di case in affitto breve. Te lo facciamo vedere durante la call, con i dati di prova.' },

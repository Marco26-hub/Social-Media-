...
export const SETTORI: Settore[] = [
  {
    ...
    cosaFacciamo: [
      ...
      { title: 'Cosa non dice l’assistente', text: 'Permute, sconti e valutazioni restano fuori dalle risposte caricate nei 300 minuti del piano: l’assistente prende i dati e passa a una persona. Le regole di passaggio le scrivi tu in avvio.' },
  ...
  },
  {
    ...
    faq: [
      { q: 'Cosa può dire l’assistente su un trattamento?', a: 'L’assistente dice solo le informazioni che hai approvato: servizi, durata di una seduta, prezzi di listino e disponibilità. Il canone base comprende 300 minuti al mese, cioè 5 ore di telefono. Ogni valutazione su pelle, controindicazioni, gravidanza o percorsi in corso resta a una persona del centro, e la chiamata viene passata secondo le regole scritte in avvio. Che si tratti di un assistente viene detto subito, non su richiesta.' },
  ...
  },
  {
    ...
    segnali: ['Nessuna risposta clinica automatica', 'Regole scritte prima dell’attivazione', 'Trascrizioni consultabili dal personale'],
    risultati: [
    ...
    ciclo: [
      { number: '01', title: 'Cosa può dire', text: 'Il documento di avvio elenca ciò che l’assistente può dire e ciò che deve trasferire, scritto con la direzione sanitaria prima di configurare i 300 o i 1500 minuti del piano. Servizi, sedi, orari e disponibilità entrano; controindicazioni ed esiti restano fuori.' },
    ...
    faq: [
      ...
      { q: 'Quali sedi e reparti si possono gestire?', a: 'La gestione multi sede è prevista con percorsi diversi per sede o reparto, fino ai 1500 minuti mensili del piano più alto, 25 ore di conversazioni. Cambiano orari, servizi disponibili e regole di trasferimento, mentre il divieto di risposta clinica resta identico ovunque. Numeri aggiuntivi, assistenti aggiuntivi e collegamenti fra sistemi vengono quotati separatamente, dopo aver visto come siete organizzati.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Cosa risponde l’assistente a chi ha dolore?', a: 'Il dolore è fra i 3 casi che passano immediatamente a una persona: nessuna valutazione, nessun consiglio, gestione secondo le regole che avete scritto. Entro i 300 minuti del canone base l’assistente gestisce prenotazioni, spostamenti, disdette e informazioni generali già approvate. Se lo studio è chiuso, comunica le indicazioni che avete predisposto, senza aggiungere interpretazioni proprie.' },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: 'Cosa serve per attività diverse da un’officina?', a: 'Il meccanismo è identico per chi lavora su appuntamento e ha scadenze periodiche: impianti, manutenzioni, assistenza tecnica, installatori. Restano le stesse 2 soglie, 300 minuti al mese di telefono e 1000 invii per i richiami. Cambiano le parole caricate nel pannello, non il funzionamento. La configurazione si adatta al vocabolario del tuo mestiere durante l’avvio.' },

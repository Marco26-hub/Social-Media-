...
export const alt = 'Segretaria telefonica AI — risponde e fissa appuntamenti | Social Web Automation'
      ...
      <div style={{ width: '100%', height: '100%', display: 'flex', background: '#133b32' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ display: 'flex', fontSize: 48, lineHeight: 1.12, fontWeight: 700, letterSpacing: -1 }}>
              Risponde al telefono anche quando tu non puoi.
            </div>
          </div>

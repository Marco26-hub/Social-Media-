...
const description='Risposte chiare su pacchetti, gestione social organica, contenuti, approvazioni, SEO, GEO, siti, consulenza AI e condizioni del servizio SWA.'
...
export const metadata:Metadata={title,description,alternates:{canonical:`${SITE_URL}/faq`,languages:{'it-IT':`${SITE_URL}/faq`,en:`${SITE_URL}/en/faq`,'x-default':`${SITE_URL}/faq`}},openGraph:{title,description,url:`${SITE_URL}/faq`, images: anteprimaOg('/faq'), type: 'website',},twitter:{title,description}}

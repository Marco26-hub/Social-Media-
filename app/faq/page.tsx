...
export const metadata:Metadata={title,description,alternates:{canonical:`${SITE_URL}/faq`,languages:{'it-IT':`${SITE_URL}/faq`,en:`${SITE_URL}/en/faq`,'x-default':`${SITE_URL}/faq`}},openGraph:{title,description,url:`${SITE_URL}/faq`, images: ['/og.png'], type: 'website',},twitter:{title,description}}

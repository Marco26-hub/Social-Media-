...
export const metadata: Metadata = { title, description, alternates:{canonical:`${SITE_URL}/metodo`,languages:{'it-IT':`${SITE_URL}/metodo`,en:`${SITE_URL}/en/method`,'x-default':`${SITE_URL}/metodo`}}, openGraph:{title,description,url:`${SITE_URL}/metodo`, images: ['/og.png'], type: 'website',}, twitter:{title,description} }

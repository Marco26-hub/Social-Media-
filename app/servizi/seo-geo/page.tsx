...
const config = {
  ...
  faq: [
    ...
    { q: 'Il servizio comprende i 12 articoli mensili?', a: 'No, sono due servizi separati. SEO + GEO è il lavoro di audit, struttura, intenti e priorità, mentre la produzione continuativa di 12 articoli al mese è il servizio Blog SEO + GEO, che costa 29,90 € al mese. Si combinano bene — la strategia decide che cosa scrivere e il blog lo scrive — ma si attivano anche uno alla volta.' },

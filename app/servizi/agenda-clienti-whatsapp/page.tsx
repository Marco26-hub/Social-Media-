...
const contenuto: ContenutoLanding = {
  ...
  settori: {
    ...
    voci: [
      ['Centri estetici', 'Pacchetti a metà, richiami stagionali, clienti sparite dopo l’estate.'],
      ['Cliniche estetiche', 'Follow-up, controlli e continuità dei percorsi.'],
      ['Parrucchieri e barberie', 'Ritmi saltati e clienti che diradano senza dire niente.'],
      ['Studi dentistici', 'Igieni da richiamare e cure preventivate mai iniziate.'],
      ['Fisioterapia e osteopatia', 'Cicli interrotti a metà e sedute mai riprese.'],
      ['Officine e servizi locali', 'Tagliandi, scadenze e manutenzioni periodiche.'],
    ],
  },

...
const config = {
  ...
  faq: [
    ...
    { q: 'Quanto costa un progetto di automazione?', a: 'È su preventivo, perché dipende dai sistemi coinvolti e dal numero di flussi da automatizzare. Definiamo perimetro e costo prima di iniziare, e ogni lavorazione aggiuntiva viene approvata prima di generare spesa: chiedere un integrativo dopo aver incassato è la peggior conversazione possibile con un cliente nuovo.' },

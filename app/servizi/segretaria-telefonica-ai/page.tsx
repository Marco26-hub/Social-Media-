...
const contenuto: ContenutoLanding = {
  ...
  settori: {
    ...
    voci: [
      ['Centri estetici', 'Chiamate durante i trattamenti, quando nessuno può rispondere.'],
      ['Cliniche estetiche', 'Prime informazioni, prenotazioni e controlli di percorso.'],
      ['Parrucchieri e barberie', 'Il telefono che squilla mentre hai le mani occupate.'],
      ['Studi dentistici', 'Prenotazioni, spostamenti e disdette dell’ultimo minuto.'],
      ['Fisioterapia e osteopatia', 'Sedute da fissare e richieste da passare allo studio.'],
      ['Officine e servizi locali', 'Preventivi, orari e disponibilità chiesti al telefono.'],
    ],
  },

...
const config = {
  ...
  faq: [
    ...
    { q: 'Che cosa succede nei primi 14 giorni?', a: 'Hai 14 giorni per valutare il servizio: configuriamo il perimetro, definiamo il piano editoriale e avviamo il primo ciclo, così vedi il metodo e la qualità su pezzi veri prima di andare avanti. Non è una prova gratuita, è una finestra in cui puoi fermarti avendo già visto il lavoro.' },

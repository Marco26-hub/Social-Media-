...
const config: MarketingDetailConfig = {
  ...
  priceNote:
    'Il sistema completo va a preventivo, perché dipende dal numero di operatori e dai modelli di scheda da scrivere per il tuo servizio. Il sito parte da €19,90 al mese per una landing semplice o un sito base, con proprietà del sito dopo 12 mesi di canone; un sito multilingua come quello di riferimento è un progetto a preventivo. L’assistente telefonico che risponde alle chiamate parte da €199 al mese con €590 di avvio. Prezzi IVA esclusa.',

...
const config = {
  ...
  faq: [
    ...
    { q: 'Inviate voi le email ai potenziali clienti?', a: 'No. Il servizio non comprende invii automatici né campagne a freddo: ricerca e contatto restano attività distinte, anche per il perimetro normativo. L’elenco lo lavora la tua rete commerciale, che sa parlare del tuo prodotto meglio di qualsiasi sequenza automatica.' },
    { q: 'Garantite appuntamenti o nuovi clienti?', a: 'No, e non lo scriviamo da nessuna parte. Garantiamo il lavoro di ricerca e qualificazione nel perimetro concordato, non le risposte, non gli appuntamenti e non le vendite: quelle dipendono da come si contatta, da che cosa si offre e dal momento in cui si arriva.' },
    ...
    { q: 'Come si definisce il cliente ideale?', a: 'Con un brief iniziale in cui fissiamo settore, area geografica, dimensione, criteri di esclusione e i segnali pubblici che rendono un’azienda interessante per te. È il passaggio che decide la qualità del risultato: un perimetro vago produce un elenco vago, e nessuna ricerca lo può salvare dopo.' },

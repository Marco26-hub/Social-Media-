  ...
  return (
    <main id="main-content" className={styles.main}>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.proofGrid}><article className={styles.proof}><Workflow size={24} aria-hidden="true" /><h3>One work flow</h3><p>Assessment, plan, production, approval and publishing are connected instead of handled as isolated tasks.</p></article><article className={styles.proof}><ShieldCheck size={24} aria-hidden="true" /><h3>Approval first</h3><p>Client approval is required before content reaches a channel or a deliverable is finalised.</p></article><article className={styles.proof}><Building2 size={24} aria-hidden="true" /><h3>Clear inclusions</h3><p>Included work, revisions, exclusions and third-party costs are stated before activation.</p></article><article className={styles.proof}><CheckCircle2 size={24} aria-hidden="true" /><h3>Public prices</h3><p>Entry points: {EN_PRICE_LABELS.web} for a website, {EN_PRICE_LABELS.blog} for the blog and {EN_PRICE_LABELS.presence} for managed social. VAT excluded.</p></article></div>
      </section>
      ...
      <section className={styles.closing}><div><p className={styles.eyebrow}>Evaluate the fit</p><h2>Tell us where work gets stuck today.</h2><p>We will point you to the smallest useful starting point before adding more moving parts.</p></div><a className={styles.primary} href={EN_WHATSAPP_URL} target="_blank" rel="noopener noreferrer">Start a conversation <ArrowRight size={16} aria-hidden="true" /></a></section>
    </main>
  )
}

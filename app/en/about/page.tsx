  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.hero}>
        ...
        <aside className={styles.identityPanel} aria-label="Company details"><Image src="/brand/swa-logo-official.png" alt="SWA Social Web Automation logo" width={260} height={119} priority /><dl><div><dt>Business</dt><dd>{EN_COMPANY.name}</dd></div><div><dt>Founder</dt><dd>{EN_COMPANY.founder}</dd></div><div><dt>Location</dt><dd>{EN_COMPANY.location}</dd></div><div><dt>VAT</dt><dd>{EN_COMPANY.vat}</dd></div></dl></aside>
      </section>

...
const offers = [
  { name: 'Presence', price: '€390 / month', result: 'Consistent presence across 2 social channels.', features: ['16 monthly content pieces per channel · 32 published posts', '4 Reels, Stories or Shorts per channel', 'Strategy, review and publishing'], href: '/register?piano=presenza', cta: 'Start Presence' },
  { name: 'Growth', price: '€790 / month', result: 'A wider system across 2 social channels.', features: ['24 monthly content pieces per channel · 48 published posts', '6 Reels, Stories or Shorts per channel', '1 SEO + GEO article', 'Management of 1 ad campaign; media budget excluded'], href: '/register?piano=crescita', cta: 'Start Growth' },

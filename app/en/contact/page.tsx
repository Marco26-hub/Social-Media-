...
export default function EnglishContactPage() {
  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.section}><div className={styles.sectionHeading}><p className={styles.eyebrow}>After you write</p><h2>What happens next, in order.</h2><p>We work in Italian and English. Replies come during Italian working hours, so allow for the time difference if you write from outside Europe.</p></div><div className={styles.journey}><article><span>01</span><h3>A reply, not a quote</h3><p>The first answer says which area looks worth touching first and which can wait. No proposal is written before that is agreed.</p></article><article><span>02</span><h3>A call if it is worth one</h3><p>Thirty minutes, to check that the problem is what it looks like from the outside. If a service is not a fit, we say so at this point.</p></article><article><span>03</span><h3>A written scope</h3><p>What is included, what is excluded, what it costs and when it renews. Published prices apply; anything outside them is quoted before it starts.</p></article><article><span>04</span><h3>Your decision</h3><p>Nothing is activated without written confirmation. Packages with a published price can also be started directly from the pricing page.</p></article></div></section>

...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: `${SITE_URL}/en/services`, locale: 'en_US' },
...
const services = [
  ...
  { id: 'video', icon: Clapperboard, title: 'Video shot on site', text: 'We come and film where you work, with a photographer, lights and proper lenses. Half a day produces vertical clips for several weeks plus stills from the same session. Quoted after a site visit.' },
  { id: 'phone', icon: PhoneCall, title: 'AI phone assistant', text: 'A number that answers while your hands are busy. It gives the services, prices and opening hours you approved, reads the calendar and books a slot; anything outside the rules is passed to you. From €199 per month, 300 minutes included — about five hours of phone.' },

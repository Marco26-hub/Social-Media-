...
const PROMPTS: Record<string, PromptSpec> = {
  ...
  'instagram:post': {
    ...
    hashtag: 'Massimo 5 hashtag totali, misti: 1-2 ampi (#fashion #moda), 1-2 di nicchia (#blazerestate), 1 branded. In coda alla caption.',
  ...
  'instagram:carousel': {
    ...
    hashtag: 'Massimo 5 hashtag. Inserire nella caption (non nelle slide).',
  ...
  'instagram:reel': {
    ...
    hashtag: 'Hashtag nella caption: massimo 5 totali, con mix trend/nicchia/branded.',
